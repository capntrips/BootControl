...
public interface IBootControl extends android.hardware.boot.V1_0.IBootControl {
    ...
    public static IBootControl getService(String serviceName, boolean retry) throws android.os.RemoteException {
        return IBootControl.asInterface(android.os.HwBinder.getService("android.hardware.boot@1.1::IBootControl", serviceName, retry));
    }
    ...
    public static IBootControl getService(String serviceName) throws android.os.RemoteException {
        return IBootControl.asInterface(android.os.HwBinder.getService("android.hardware.boot@1.1::IBootControl", serviceName));
    }
     ...
     */
    boolean setSnapshotMergeStatus(int status)
